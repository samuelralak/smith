...
RSpec.describe "Smith::Workflow contract" do
  ...
  it "supports stepwise execution, full-run execution, serialization hooks, and durability helpers" do
    ...
    expect(workflow).to respond_to(:authorize_prepared_step_execution!)
    expect(workflow).to respond_to(:execute_authorized_prepared_step!)
    expect(workflow).to respond_to(:release_prepared_step_execution!)
